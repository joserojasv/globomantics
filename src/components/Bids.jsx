import useBids from "../helpers/hooks/useBids";
            ...
            <div className="row mt-4">
                <div className="col-12">
                    <table className="table table-sm">
                        ...
                        <tbody>
                            <ErrorBoundary fallback="An error occured when loading bids!">
                                {bids.map(b => (
                                    <tr key={b.id}>
                                        <td>{b.bidder}</td>
                ...
                <div className="row">
                    <form action={bidSubmitAction} className="row row-cols-lg">
                        <div className="col-5">
                            <input
                                id="bidder"
